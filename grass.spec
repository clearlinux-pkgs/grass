...
Version  : 8.4.1
Release  : 68
URL      : https://github.com/OSGeo/grass/archive/8.4.1/grass-8.4.1.tar.gz
Source0  : https://github.com/OSGeo/grass/archive/8.4.1/grass-8.4.1.tar.gz
...
%prep
%setup -q -n grass-8.4.1
cd %{_builddir}/grass-8.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742520211
